...
func (as *Server) registerRoutes() {
	...
	v1.HandleFunc("/interfaces", mid.Use(as.ListInterfaces, mid.RequirePermission(models.PermissionModifySystem))).Methods("GET")
	v1.HandleFunc("/tunnel/status", mid.Use(as.TunnelStatus, mid.RequirePermission(models.PermissionModifySystem))).Methods("GET")
	v1.HandleFunc("/tunnel/start", mid.Use(as.StartTunnelServer, mid.RequirePermission(models.PermissionModifySystem))).Methods("POST")
	v1.HandleFunc("/tunnel/stop", mid.Use(as.StopTunnelServer, mid.RequirePermission(models.PermissionModifySystem))).Methods("POST")
	v1.HandleFunc("/tunnel/route", mid.Use(as.AddRoute, mid.RequirePermission(models.PermissionModifySystem))).Methods("POST")
