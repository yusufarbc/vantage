// Package models: read-side campaign queries -- fetching campaigns, their
// summaries/statistics, and the lightweight mail-context projection used
// by the worker. Mutating operations live in campaign_write.go.
package models
